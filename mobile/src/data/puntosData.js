...
export const PUNTOS_INICIALES = [
  ...
  // --- Kit del recién llegado (verificar en campo: coordenadas y horarios aproximados) ---
  {
    id: 600,
    nombre: 'Aeropuerto Internacional Coronel FAP Francisco Secada Vignetta',
    categoria: 'transporte',
    subcategoria: 'Aeropuerto',
    calle: 'Av. José Abelardo Quiñones km 6',
    direccion: 'Av. José Abelardo Quiñones km 6, San Juan Bautista',
    lat: -3.7847,
    lng: -73.3088,
    distancia: '~7 km de Plaza de Armas',
    acceso: 'Mototaxi o taxi por la Av. Quiñones (20-30 min)',
    costo: 'Mototaxi al centro S/ 15 - S/ 20 aprox.',
    horario: 'Según vuelos, aprox. 5:00 AM - 11:00 PM',
    descripcionCorta: 'Única puerta aérea de Iquitos: la ciudad no tiene carretera al resto del Perú.',
    descripcionLarga: 'Aeropuerto principal de Loreto, con vuelos diarios a Lima y otras ciudades. Al salir encontrarás mototaxis y taxis; acuerda la tarifa antes de subir.',
    recomendaciones: 'Lleva efectivo en soles para el traslado y acuerda el precio antes de subir.',
    rating: 4.2,
    resenas: [],
    verificar: true
  },
  {
    id: 601,
    nombre: 'BCP - Banco de Crédito (Jr. Próspero)',
    categoria: 'servicios',
    subcategoria: 'Cajero / Banco',
    calle: 'Jr. Próspero',
    direccion: 'Jr. Próspero, cuadra 2, centro de Iquitos',
    lat: -3.7497,
    lng: -73.2441,
    distancia: '~0.2 km de Plaza de Armas',
    acceso: 'A pie desde la Plaza de Armas',
    costo: 'El retiro con tarjeta extranjera puede cobrar comisión',
    horario: 'Agencia L-V 9:00 AM - 6:00 PM, sábado por la mañana; cajeros 24 h aprox.',
    descripcionCorta: 'Banco con cajeros automáticos en la calle comercial del centro.',
    descripcionLarga: 'En Jr. Próspero se concentran varios bancos y cajeros. Aquí puedes retirar soles; en Iquitos casi todo se paga en efectivo.',
    recomendaciones: 'Retira de día y guarda el dinero antes de salir del cajero.',
    rating: 4.0,
    resenas: [],
    verificar: true
  },
  {
    ...
    lat: -3.7275,
    lng: -73.2535,
    distancia: '~3 km de Plaza de Armas',
    acceso: 'Mototaxi desde el centro (10-15 min)',
    costo: 'Atención pública, tarifas según servicio',
    horario: 'Emergencias 24 horas',
    descripcionCorta: 'Principal hospital público de la región, con emergencias 24 horas.',
    descripcionLarga: 'Hospital de referencia de Loreto. Atiende emergencias, consultas y hospitalización.',
    recomendaciones: 'Lleva tu documento de identidad y tu seguro de viaje.',
    rating: 3.8,
    resenas: [],
    verificar: true
  },
  {
    id: 603,
    nombre: 'Clínica Ana Stahl',
    categoria: 'servicios',
    subcategoria: 'Salud',
    calle: 'Av. La Marina',
    direccion: 'Av. La Marina 285, Iquitos',
    lat: -3.7385,
    lng: -73.2495,
    distancia: '~1.3 km de Plaza de Armas',
    acceso: 'Mototaxi corto desde el centro (5 min)',
    costo: 'Clínica privada, consulta desde S/ 60 aprox.',
    horario: 'Emergencias 24 horas',
    descripcionCorta: 'Clínica privada adventista con emergencias 24 horas.',
    descripcionLarga: 'Una de las clínicas privadas más conocidas de Iquitos, con emergencias, consultas y laboratorio.',
    recomendaciones: 'Consulta si tu seguro de viaje tiene convenio.',
    rating: 4.1,
    resenas: [],
    verificar: true
  },
  {
    id: 604,
    nombre: 'EsSalud Hospital III Iquitos',
    categoria: 'servicios',
    subcategoria: 'Salud',
    calle: 'Punchana',
    direccion: 'Punchana, Iquitos',
    lat: -3.7330,
    lng: -73.2510,
    distancia: '~2 km de Plaza de Armas',
    acceso: 'Mototaxi desde el centro (10 min)',
    costo: 'Para asegurados de EsSalud; emergencias graves se atienden',
    horario: 'Emergencias 24 horas',
    descripcionCorta: 'Hospital del seguro social peruano con emergencias 24 horas.',
    descripcionLarga: 'Hospital de EsSalud para asegurados. En emergencias graves atiende a cualquier persona.',
    recomendaciones: 'Si no eres asegurado, prefiere el Hospital Regional o una clínica privada.',
    rating: 3.7,
    resenas: [],
    verificar: true
  },
  {
    id: 605,
    nombre: 'Tienda Claro (Jr. Próspero)',
    categoria: 'servicios',
    subcategoria: 'Chip y telefonía',
    calle: 'Jr. Próspero',
    direccion: 'Jr. Próspero, centro de Iquitos',
    lat: -3.7502,
    lng: -73.2439,
    distancia: '~0.3 km de Plaza de Armas',
    acceso: 'A pie desde la Plaza de Armas',
    costo: 'Chip prepago desde S/ 5 aprox.',
    horario: 'L-S 9:00 AM - 8:00 PM aprox.',
    descripcionCorta: 'Compra un chip prepago peruano con datos móviles.',
    descripcionLarga: 'Tienda del operador Claro en la calle comercial. Para comprar un chip necesitas tu pasaporte.',
    recomendaciones: 'Lleva tu pasaporte: el registro del chip es obligatorio.',
    rating: 4.0,
    resenas: [],
    verificar: true
  },
  {
    id: 606,
    nombre: 'Tienda Movistar (Jr. Próspero)',
    categoria: 'servicios',
    subcategoria: 'Chip y telefonía',
    calle: 'Jr. Próspero',
    direccion: 'Jr. Próspero, centro de Iquitos',
    lat: -3.7508,
    lng: -73.2436,
    distancia: '~0.4 km de Plaza de Armas',
    acceso: 'A pie desde la Plaza de Armas',
    costo: 'Chip prepago desde S/ 5 aprox.',
    horario: 'L-S 9:00 AM - 8:00 PM aprox.',
    descripcionCorta: 'Chip prepago y recargas del operador Movistar.',
    descripcionLarga: 'Tienda del operador Movistar en el centro. Para comprar un chip necesitas tu pasaporte.',
    recomendaciones: 'Lleva tu pasaporte: el registro del chip es obligatorio.',
    rating: 4.0,
    resenas: [],
    verificar: true
  ...
  {
    id: 607,
    nombre: 'Cambistas de Jr. Próspero y Jr. Putumayo',
    categoria: 'servicios',
    subcategoria: 'Cambio de moneda',
    calle: 'Jr. Próspero / Jr. Putumayo',
    direccion: 'Esquina de Jr. Próspero con Jr. Putumayo, junto a la Plaza de Armas',
    lat: -3.7490,
    lng: -73.2443,
    distancia: '~0.1 km de Plaza de Armas',
    acceso: 'A pie desde la Plaza de Armas',
    costo: 'Sin comisión; compara el tipo de cambio',
    horario: 'L-S 8:00 AM - 7:00 PM aprox.',
    descripcionCorta: 'Zona de cambistas y casas de cambio para dólares y euros.',
    descripcionLarga: 'Alrededor de Jr. Próspero y Jr. Putumayo hay cambistas con chaleco y casas de cambio. Cuenta el dinero delante de ellos.',
    recomendaciones: 'Prefiere casas de cambio con local y revisa los billetes que recibes.',
    rating: 3.9,
    resenas: [],
    verificar: true
  }
