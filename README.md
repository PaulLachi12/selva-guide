...
| Área | Tecnología |
| --- | --- |
| Mobile | Expo SDK 57, React Native 0.86, expo-router, react-native-maps, i18next, expo-sqlite, expo-location |
...
- El CI revisa traducciones, bundle de Android, sintaxis del backend y build del panel web.
